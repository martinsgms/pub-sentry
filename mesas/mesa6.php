...
<div id="mySidenav" class="sidenav" style="background-color: #000;">
 ...
 <div class="modal fade" id="myModal" role="dialog">
  ...
  <div class="row">
    <div class="main">
    <p style="text-align: center; font-size: 50pt;">Mesa 6<p>
    <hr>
        ...
        <table width="500"  align="center" class="table">
          ...
          <tr><td></td><td></td><td></td><td></td>
            ...
            $row = $result->fetch_assoc();
             ...
             ?></td>  <td><button type="submit"  class="btn btn-primary" data-toggle="modal" data-target="#myModal3" onclick="load_modal3('<?php echo $value->id; ?>')">Finalizar Consumo</button></td><td></td>
          </tr>
